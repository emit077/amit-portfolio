<template>
  <div class="wrapper">
    <div class="card">
      <img src="../../assets/images/projects/cashpo.png" alt="" width="100%" height="280px">
      <div>
        <h3>
          Cashpo
        </h3>
...
.card {
  ...
  //background-image: url("../../assets/images/projects/cashpo.png");
